//! ChaosSeal Benettin Lyapunov estimator.
//!
//! Vendored verbatim from `core_v2/src/lyapunov/benettin.rs` at core_v2
//! @ 29be3b5 (merge of PR #20). Deltas: alloc imports added (`Vec`/`vec!`
//! need `alloc::` paths under no_std).

#![allow(dead_code)]

pub mod benettin {
    use alloc::{vec, vec::Vec};
    use crate::vendor::fixed::Q32_32;
    ...
    impl LyapunovEstimator {
        pub fn estimate<F, G, R>(&self, system: &F, jacobian: &G, reinject: &R, t0: Q32_32, initial_state: &[Q32_32]) -> Q32_32
        where
...
pub use benettin::LyapunovEstimator;
