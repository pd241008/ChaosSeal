//! ChaosSeal multi-pendulum kinematics + RK4 integrator.
//!
//! Vendored verbatim from `core_v2/src/kinematics/{pendulum,rk4}.rs` at
//! core_v2 @ 29be3b5 (merge of PR #20). No deltas — these modules were
//! already std-free (alloc-only).
...
pub use pendulum::MultiPendulum;
